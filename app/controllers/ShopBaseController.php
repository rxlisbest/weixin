...
class ShopBaseController extends \BaseController {
	...
	public function  __construct(){
		$this->shopName = Request::segment(1);
		$this->shopId = User::where('username', '=', $this->shopName)->first()->id;
		$this->item_class_list = ItemClass::WhereRaw('status=? and shopId=?', array(1, $this->shopId))->get() ?: array();
