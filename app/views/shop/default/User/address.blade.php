...
<div id="content">
    <div class="wrap">
        <div class="eject_btn" title="新增地址"><a class="enter" href="{{URL::to($shopName."/shopuser/addaddress")}}">新增地址</a></div> 
        <!-----------
	...
	@foreach($address_list as $vo)
            <li>
                ...
                <p class="address_action">
                    <span class="edit"><a href="{{URL::to($shopName."/shopuser/editaddress")}}/{{$vo->id}}"><i class="edit_icon"></i>编辑</a></span>
                    <span><a href="{{URL::to($shopName."/shopuser/deladdress")}}/{{$vo->id}}" class="delete float_none"><i class="delete_icon"></i>删除</a></span>
                </p>
            </li>
	@endforeach
        </ul>
