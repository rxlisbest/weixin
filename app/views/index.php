...
<html lang="en">
	<head>
		...
		<link href="/public/statics/css/bootstrap-responsive.min.css" rel="stylesheet" />
		<link rel="stylesheet" href="/public/statics/css/font-awesome.min.css" />
		<!--[if IE 7]>
		  <link rel="stylesheet" href="/public/statics/css/font-awesome-ie7.min.css" />
		<![endif]-->
		<!-- page specific plugin styles -->
		
		<!-- ace styles -->
		<link rel="stylesheet" href="/public/statics/css/ace.min.css" />
		<link rel="stylesheet" href="/public/statics/css/ace-responsive.min.css" />
		<link rel="stylesheet" href="/public/statics/css/ace-skins.min.css" />
		<!--[if lt IE 9]>
		  <link rel="stylesheet" href="/public/statics/css/ace-ie.min.css" />
		<![endif]-->
	</head>
	<body>
...
<!-- PAGE CONTENT ENDS HERE -->
		...
		<!-- basic scripts -->
		<script src="/public/statics/1.9.1/jquery.min.js"></script>
		<script type="text/javascript">
		window.jQuery || document.write("<script src='/public/statics/js/jquery-1.9.1.min.js'>\x3C/script>");
		</script>
		...
		<!--[if lt IE 9]>
		<script type="text/javascript" src="/public/statics/js/excanvas.min.js"></script>
		<![endif]-->
		<script type="text/javascript" src="/public/statics/js/jquery-ui-1.10.2.custom.min.js"></script>
		<script type="text/javascript" src="/public/statics/js/jquery.ui.touch-punch.min.js"></script>
		<script type="text/javascript" src="/public/statics/js/jquery.slimscroll.min.js"></script>
		<script type="text/javascript" src="/public/statics/js/jquery.easy-pie-chart.min.js"></script>
		<script type="text/javascript" src="/public/statics/js/jquery.sparkline.min.js"></script>
		<script type="text/javascript" src="/public/statics/js/jquery.flot.min.js"></script>
		<script type="text/javascript" src="/public/statics/js/jquery.flot.pie.min.js"></script>
		<script type="text/javascript" src="/public/statics/js/jquery.flot.resize.min.js"></script>
		<!-- ace scripts -->
		<script src="/public/statics/js/ace-elements.min.js"></script>
		<script src="/public/statics/js/ace.min.js"></script>
